...
class FPNInception4xSR(nn.Module):
    ...
    def __init__(self, norm_layer, output_ch=3, num_filters=128, num_filters_fpn=256):
        ...
        self.pre_final_2 = nn.Conv2d(num_filters // 2, num_filters // 2, kernel_size=3, padding=1)
        self.pre_final_2 = nn.Conv2d(num_filters // 2, num_filters // 2, kernel_size=3, padding=1)
    ...
    def forward(self, x):
        ...
        pre_final = nn.functional.upsample(self.pre_final_2(smoothed), scale_factor=2, mode = "nearest")
        final = nn.functional.upsample(self.pre_final_1(pre_final), scale_factor=2, mode = "nearest")
